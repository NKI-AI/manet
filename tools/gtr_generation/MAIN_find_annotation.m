...
%annotation_folder='Y:\projects\benedetta\ge\annotations_test\';

%list_name='ge_test_calc_stage1.elst';
%dir_dicom='Y:\projects\benedetta\ge\features_test\';
%out_dir='Y:\projects\benedetta\ge\groundtruth_test_improved\';

mount_name='Y:\projects\benedetta\holo_data\';
annotation_folder='Y:\projects\benedetta\holo_data\annotations\';

list_name='hologic_train_calc_stage1.elst';
dir_dicom='Y:\projects\benedetta\holo_data\features\';
out_dir='';



%list_file_name=strcat(mount_name,list_name);
list_file_name='C:\Users\bened\Desktop\grt_train\hologic_train_calc_stage1.elst'
disp(list_file_name)
