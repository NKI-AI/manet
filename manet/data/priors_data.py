...
from manet.data.transforms import RandomElasticTransform, RandomGammaTransform, RandomZoomTransform, \
...
class PriorSet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #print([(val, type(sample[val])) for val in sample], i, idx)
        return sample
